...
/*
<ul class="submenu" id="log_list">
	<li class="sub-accordion">
		<div class="sublink">log_name<i class="fa fa-chevron-down"></i></div>
		<ul class="sub-submenu">
			<li><a href="#">watch<input type="checkbox" class="toggle_button"></a></li>
			<li>
				<a href="#">color
								<div class="custom_select_box namespace_box">
										<select required>
										<option value="1">cat</option>
										<option value="2">dog</option>
										<option value="3">rabbit</option>
										<option value="4">squirrelllllllllllllllllllllllllllllllllllllllllllll</option>
									</select>
								</div>
								<input type="color" class="color_input" value="#ff0000" id="colorWell">
				</a>
			</li>
			<li id="sub-sub-accordion" class="sub-sub-accordion">
				<div class="sub-sublink">log info<i class="fa fa-chevron-down"></i></div>
				<ul class="sub-sub-submenu">
					<li><div class="second-indent"><a href="#">time stamp:<p>19700101 00:00:00</p></a></div></li>
					<li><div class="second-indent"><a href="#">namespaces:<p>train, val, test, other</p></a></div></li>
				</ul>
			</li>
			<li id="sub-sub-accordion" class="sub-sub-accordion">
				<div class="sub-sublink">git info<i class="fa fa-chevron-down"></i></div>
				<ul class="sub-sub-submenu">
					<li><div class="second-indent"><a href="#">hash: qawsedrftgyhujikolp;@:[]</a></div></li>
					<li><div class="second-indent"><a href="#">branch: master</a></div></li>
				</ul>
			</li>
			<li id="sub-sub-accordion" class="sub-sub-accordion">
				<div class="sub-sublink">argument<i class="fa fa-chevron-down"></i></div>
				<ul class="sub-sub-submenu">
					<li><div class="second-indent"><a href="#">data_dir:<p>dataset/iCoseg/public_data/horse</p></a></div></li>
					<li><div class="second-indent"><a href="#">batch_size:<p>tanosii</p></a></div></li>
				</ul>
			</li>
		</ul>
	</li>
	...
	.
	.
"<li class=\"sub-accordion\"><div class=\"sublink\" id=\""+log_name"\">"+log_name
"<i class=\"fa fa-chevron-down\"></i></div><ul class=\"sub-submenu\"><li><a href=\"#\">watch<input type=\"checkbox\" class=\"toggle_button\" id=\""+log_name"\"></a></li><li><a href=\"#\">color<div class=\"custom_select_box namespace_box\"><select required>"

for
<option value="0">cat</option>
<option value="1">dog</option>
<option value="2">rabbit</option>
<option value="3">squirrelllllllllllllllllllllllllllllllllllllllllllll</option>

"</select></div><input type=\"color\" class=\"color_input\" value=\"#ff6622\" id=\"colorWell "+log_name
"\"></a></li>"
"<li id=\"sub-sub-accordion\" class=\"sub-sub-accordion\"><div class=\"sub-sublink\">log info<i class=\"fa fa-chevron-down\"></i></div><ul class=\"sub-sub-submenu\">"

for
"<li><div class=\"second-indent\"><a href=\"#\">time stamp:<p>19700101 00:00:00</p></a></div></li>"
"<li><div class=\"second-indent\"><a href=\"#\">namespaces:<p>train, val, test, other</p></a></div></li>"

"</ul></li><li id=\"sub-sub-accordion\" class=\"sub-sub-accordion\"><div class=\"sub-sublink\">git info<i class=\"fa fa-chevron-down\"></i></div><ul class=\"sub-sub-submenu\">"

for
"<li><div class=\"second-indent\"><a href=\"#\">hash: qawsedrftgyhujikolp;@:[]</a></div></li>"
"<li><div class=\"second-indent\"><a href=\"#\">branch: master</a></div></li>"

"</ul></li><li id=\"sub-sub-accordion\" class=\"sub-sub-accordion\"><div class=\"sub-sublink\">argument<i class=\"fa fa-chevron-down\"></i></div><ul class=\"sub-sub-submenu\">"
	...
	"log_output_20180819_03-40-24":{
		...
		"info": {
			"argments": [
				...
				{"decay_every": 80}, {"decay_value": 0.1},
				{"epochs": 200},
				{"gpu_device_num": 0},
				{"learning_rate": 0.01},
				{"log_server": false},
				...
				{"notqdm": false},
				{"num_workers": 8},
				{"q_dataset": "/home/baba/Programs/dataset/pascal2012/VOCdevkit/VOC2012_alt_v2/"},
				{"q_epochs": 50},
				{"query_crop_size": 256},
				{"query_resize_size": 300},
				{"resize_size": 300},
				{"rotate_deg": 10},
				{"save_dir": "./log/"},
				{"save_every": 10},
				{"show_parameters": false},
				{"train_dataset": "/home/baba/Programs/dataset/pascal2012/VOCdevkit/VOC2012_alt_v2/"},
				{"train_dataset_pickle": "/home/baba/Programs/dataset/pascal2012/VOCdevkit/VOC2012_alt_v3/train_dataset.pkl"},
				{"train_query": false},
				{"trained_path": "resnet34-333f7ec4.pth"},
				{"trainval_every": 10},
				{"use_tensorboard": false},
				{"val_dataset": "/home/baba/Programs/dataset/pascal2012/VOCdevkit/VOC2012_alt_v2/"},
				{"val_dataset_pickle": "/home/baba/Programs/dataset/pascal2012/VOCdevkit/VOC2012_alt_v3/val_dataset.pkl"},
				{"val_negative_sample_rate": 0.0},
				{"val_server_port": 8080}
			],
			"git_info": {
				"branch_hash": "None",
			...
			"log_info": {
				"logs": {
					"train": {"file_name": "train_20180819_03-40-24.csv"},
					"val": {"file_name": "val_20180819_03-40-24.csv"}
				}, 
				"namespaces": ["train", "val"]
			},
			"log_name": "log_output",
			"time_stamp": "20180819 03:40:24"
		}
	}
]}
*/
...
<div class="timeline-wrapper">
	...
	<div class="timeline-box">
		<div class="timeline">
			...
			<div class="timeline-entry">
				<div class="timeline-title">
					<h3>epoch 1 validation output</h3>
					<p>batch 0</p>
				</div>
				<div class="timeline-body">
					<div class="luminous-imgbox">
						<a class="luminous luminous-img zoom-in" href="static/img/img1.jpg">
							<img src="static/img/img1.jpg" style="width: 159px;" alt="代替テキスト!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!">
						</a>
						<a class="luminous luminous-img zoom-in" title="aaaaaaaaaaaaaaaaa" href="static/img/img2.jpg">
							<img src="static/img/img2.jpg" style="width: 159px;" alt="代替テキスト">
						</a>
						<a class="luminous luminous-img zoom-in" href="static/img/img1.jpg">
							<img src="static/img/img1.jpg" style="width: 159px;" alt="代替テキスト">
						</a>
						...
						<a class="luminous luminous-img zoom-in" href="static/img/img2.jpg">
							<img src="static/img/img2.jpg" style="width: 159px;" alt="代替テキスト">
						</a>
						<a class="luminous luminous-img zoom-in" href="static/img/img1.jpg">
							<img src="static/img/img1.jpg" style="width: 159px;" alt="代替テキスト">
						...
						<p>caption</p>
						<ul>
							<li>women is riding on a horse.</li>
						</ul>
					</div>
				</div>
			</div>
	...
	if(global_fetch_update_go){
		var req_update_log = new XMLHttpRequest();
	  	...
	  	req_update_log.onload = function(){
	  		...
	  		console.log(global_log_data)
	  		console.log(global_loaded_history)
	  	}
